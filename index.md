...
- **Reinforcement Learning** (Sample efficiency, intrinsic motivation, etc.)
- **Embodied Intelligence** (Humanoid robotics, VLA models, etc.)
- **Continual Learning** (Anti-forgetting, plasticity, etc.)
- **Machine Learning Systems** (AI Infra, agent-based systems, etc.)
...
- **[July, 2025]** One paper accepted by ICCV2025!
- **[Apr, 2025]** RLeXplore is accepted by the Transactions on Machine Learning Research!
- **[Dec, 2024]** RLLTE is going to be displayed in AAAI 2025. See you in Philadelphia!
- **[Jan, 2024]** I'm going to visit the University of Cambridge from February!
- **[Apr, 2023]** One paper accepted by the ICML 2023!

<!-- ## Experiences

- **LimX Dynamics**, Research Intern, 2025
- **Tencent Robotics X Lab**, Research Intern, 2022
- **JD.com, Inc.**, Research Intern, 2019 -->
...
<!-- ## Honors
- Full Research Postgraduate Scholarship, PolyU
- Research Student Attachment Scholarship, PolyU -->
